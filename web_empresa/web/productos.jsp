<%-- 
    Document   : productos
    Created on : 17/10/2020, 17:02:35
    Author     : Wilmer
--%>
                    ...
                    <div class="modal-content">
                        <form action="sr_productos" method="post" class="form-group" > 
                            ...
                            <div class="modal-body">                                
                                ...
                                <input type="number" step="0.1" name="txt_precio_costo" id="txt_precio_costo" class="form-control" placeholder="Ejemplo: 2.5" >
                                <label><b>Precio de venta: </b></label>
                                <input type="number" step="0.1" name="txt_precio_venta" id="txt_precio_venta" class="form-control" placeholder="Ejemplo: 3.2" >                                
                                <label><b>Existencia: </b></label>
                                <input type="number" name="txt_existencia" id="txt_existencia" class="form-control" placeholder="Ejemplo: 2000">
                    ...
                    <div class="modal-content">
                        <form action="sr_productos" method="post" class="form-group" >
                            ...
                            <div class="modal-body">                                
                                ...
                                <%--<label><b>Fecha de ingreso: </b></label>--%>
                                <input type="hidden" name="txt_fecha_ingreso" id="fecha" class="form-control" readonly>
                            </div>
