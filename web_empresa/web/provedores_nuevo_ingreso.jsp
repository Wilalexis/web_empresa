<%-- 
    Document   : provedores_nuevo_ingreso
    Created on : 8/11/2020, 21:12:30
    Author     : Wilmer
--%>
                    ...
                    <div class="modal-content">
                        <form action="sr_proveedor" method="post" class="form-group" >
                            ...
                            <div class="modal-body">                                
                                ...
                                <input type="hidden" name="txt_id_proveedor" id="txt_id_proveedor" class="form-control" value="0" readonly>
                            ...
                            <div class="modal-footer">
                                <button class="btn btn-info btn-block"  name="btn_agregarP" id="btn_agregarP" value="agregarP"><b>Agregar</b></button>
                            </div>
                        </form>    
                    </div>
                </div>
